        ...
        <div className="footer__content">
          ...
          <div className="footer__section">
            ...
            <p className="footer__description">
              A modern weather application built with React 19 and the MERN stack.
              Get real-time weather data, forecasts, and manage your favorite locations.
            </p>
          ...
          <div className="footer__section">
            ...
            <ul className="footer__links">
              ...
              <li>
                <Link to="/search" className="footer__link">Search Weather</Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/test" className="footer__link">API Test</Link>
              </li>
            </ul>
          </div>
